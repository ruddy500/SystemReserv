...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>    
      ...
      @yield('inicio')
      @yield('ambientes')
      @yield('ambientes/horario')
      @yield('ambientes/ver')
      @yield('ambientes/editar')
      @yield('reservas/admin/principal')
      @yield('reservas/principal')
      @yield('reservas/verIndividual')
